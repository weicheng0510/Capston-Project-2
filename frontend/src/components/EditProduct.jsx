...
const EditProduct = ({ onClose, product, fetchProducts }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await fetch(Api.updateProduct.url, {
                ...
                <form className='overflow-y-scroll p-2 h-full max-h-[90%]' onSubmit={handleSubmit}>
                    ...
                    <div className='flex gap-10'>
                        ...
                        <div className='mb-2'>
                            ...
                            <input type='number' id='price' name='price' value={data.price} onChange={(e) => {
                            ...
                            }} className='border border-gray-400 w-full p-1 bg-gray-100 rounded-md' required />
                        </div>
                        {/* quantity */}
                        <div className='mb-2'>
                            <label htmlFor='quantity'>Quantity: </label>
                            <input type='number' id='quantity' name='quantity' value={data.quantity} onChange={(e) => {
                                const value = e.target.value;
